    ...
    <div className="landing-header">
      ...
      <div className="nav">
        <nav>
          <ul>
            <li>
              <a className='nav-links' href="#about" onClick={scrollDownToTop}>
                About Us
              </a>
            </li>
            <li>
              <a className='nav-links' href="#feature" onClick={scrollDownToFeature}>
                Features
              </a>
            </li>
            <li>
              <a className='nav-links' href="#faq" onClick={scrollDown}>
                FAQS
              </a>
            </li>
          </ul>
        </nav>
        <button onClick={handleActive} className="landing-header-button">
          Join Waitlist
        </button>
      </div>
    </div>
