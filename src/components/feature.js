    ...
    <div className="feature">
      <div className="feature-body-1">
        <div className="feature-title">
          <p className=" font">
            Prioritizing your <br className="h2" /> need is our utmost business.
          </p>
        </div>
        <div className="feature-detail">
          We intend to help our user track their revenue flow & provide
          <br className="h2" /> top-notch security against fraud & privacy
          invasion
        </div>
