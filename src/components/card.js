    ...
    return(
        <div className="section2">
          ...
          <div className="section2-text-section">
            <h2>Request cash, pay bills <br className="h2"/> - all in one place</h2>
            <p>
              Zojapay allow users conveniently request for cash to be <br className="h2"/>delivered
              to their location as well as sorting out their bills.
            </p>
          </div>
          <div className="section2-cards">
            <div className="section2-card card1">
              ...
              <h4>Request Cash</h4>
              <p>
                Users can have cash delivered to them anywhere in the country in
                less than a minutes.
              </p>
            </div>
            ...
            <div className="section2-card card2">
              ...
              <p>
                Users can request for cash to be delivered to anyone, anywhere
                from their profile.
              </p>
            </div>
            <div className="section2-card card3">
              ...
              <h4>Bills Payment</h4>
              <p>
                Users can settle bills and utilties across various billing
                agents operating in Nigeria.
              </p>
            </div>
          </div>
          <img style={{position: "absolute", marginLeft: "25%", marginTop: "1%", marginBottom: "-21px"}} src={circle} alt="svg"/>
        </div>
    )
}