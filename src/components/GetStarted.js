  ...
  return (
    <div className="get-started">
      ...
      <h3 className="head" style={{ color: "#323348" }}>
        Perks as a ZojaPay Cash Service Officer
      </h3>
      <div className="content">
        ...
        <div className="quick-registration">
          ...
          <p className="text">
            As an existing POS agent, using ZojaPay helps you get wider reach &
        ...
        <div className="quick-registration">
          ...
          <p className="text">
            ...
            get access to ZojaPay branding & Business Suport loans
          </p>
        </div>
      </div>
